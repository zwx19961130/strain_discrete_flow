function [Kx, Ky, Omega] = estimateOpticFlow2D(ImgSeq, opt)
% estimateOpticFlow2D
...
if ~isfield(opt,'f'),       opt.f       = 0.8;              end % cycles per pixel or frame 1/4 original
...
fKernel     = @(sigma)      (-floor(sigma):+1:+floor(sigma));
