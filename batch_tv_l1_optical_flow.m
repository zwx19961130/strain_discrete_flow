...
% image1_phase_horizontal = zeros(size(I1));
% for i = 1 : 6
%     theta_tmp = pi / 6 * i;
%     [Eim1, Oim1, ~] = spatialgabor(I1, 0.6, theta_tmp, 3, 3, 1);
%     image1_phase_horizontal_tmp = angle(Eim1 + 1i * Oim1);
%     image1_phase_horizontal = image1_phase_horizontal + image1_phase_horizontal_tmp;
% end
% 
% 
% 
% image2_phase_horizontal = zeros(size(I1));
% for i = 1 : 6
%     theta_tmp = pi / 6 * i;
%     [Eim1, Oim1, ~] = spatialgabor(I2, 0.6, theta_tmp, 3, 3, 1);
%     image2_phase_horizontal_tmp = angle(Eim1 + 1i * Oim1);
%     image2_phase_horizontal = image2_phase_horizontal + image2_phase_horizontal_tmp;
% end
% [Eim1, Oim1, ~] = spatialgabor(I1, 1 / 0.6, 0, 3, 3, 1);
% [Eim2, Oim2, ~] = spatialgabor(I2, 1 / 0.6, 0, 3, 3, 1);
% 
% 
