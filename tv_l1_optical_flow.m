...
% [~, image1_phase_horizontal] = imgaborfilt(I1, 2, 0, 'SpatialFrequencyBandwidth', 2.61, 'SpatialAspectRatio', 20.0);
% [~, image2_phase_horizontal] = imgaborfilt(I2, 2, 0, 'SpatialFrequencyBandwidth', 2.61, 'SpatialAspectRatio', 20.0);
% ksize = 9;
% theta = 0;
% % f = 3;
% gamma = -13.8;
...
% lambda = 0.3003;
% 
% gb = my_gabor(ksize, theta, gamma, sigma, lambda, psi);
