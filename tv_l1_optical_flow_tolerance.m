function [u, v, w, p] = tv_l1_optical_flow(I1, I2, options) 
...
for level = pyramid_levels:-1:1  %1--->2
  ...
  [u, v, w, p, k] = champolle_pock_primal_dual_alg(I1, I2, ...
                        u, v, w, p, lambda, warps, beta, tolerence, check); 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [u, v, w, p, k] = champolle_pock_primal_dual_alg(I1, I2, ...
                               u, v, w, p, lambda, warps, beta, tolerence, check)
                           %maxits, scale, check)
% [M N C] = size(I1);
